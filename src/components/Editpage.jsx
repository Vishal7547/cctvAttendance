          ...
          <Form onSubmit={handleSubmit}>
            ...
            <FormGroup>
              <FormControl
                type="hidden"
                name="current_avatar"
                value="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-dsc/avatars/sameer_._PtZegxS.jpg"
                id="id_current_avatar"
              />
              {/* Your avatar UI code */}
            </FormGroup>
            ...
            {/* Submit button */}
            <div
              className="form-actions pull-right text-right "
              style={{
                display: "flex",
